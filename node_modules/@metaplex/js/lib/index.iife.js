var metaplex = (function (exports, web3_js, splToken) {
  ...
  ***************************************************************************** */
  ...
  _a$F = BidderMetadataData;
  BidderMetadataData.SCHEMA = _a$F.struct([
  ...
  _a$E = BidderPotData;
  BidderPotData.SCHEMA = _a$E.struct([
  ...
  _a$C = AuctionDataExtended;
  AuctionDataExtended.SCHEMA = _a$C.struct([
  ...
  _a$B = CancelBidArgs;
  CancelBidArgs.SCHEMA = _a$B.struct([
      ['instruction', 'u8'],
  ...
  _a$A = WinnerLimit;
  WinnerLimit.SCHEMA = _a$A.struct([
      ['type', 'u8'],
      ['usize', 'u64'],
  ]);
  ...
  _a$y = PlaceBidArgs;
  PlaceBidArgs.SCHEMA = _a$y.struct([
      ['instruction', 'u8'],
      ['amount', 'u64'],
      ['resource', 'pubkeyAsString'],
  ]);
  ...
  _a$x = SetAuctionAuthorityArgs;
  SetAuctionAuthorityArgs.SCHEMA = _a$x.struct([['instruction', 'u8']]);
  ...
  _a$w = AuctionManagerStateV2;
  AuctionManagerStateV2.SCHEMA = _a$w.struct([
      ['status', 'u8'],
  ...
  _a$v = PayoutTicketData;
  PayoutTicketData.SCHEMA = _a$v.struct([
      ['key', 'u8'],
  ...
  _a$u = PrizeTrackingTicketData;
  PrizeTrackingTicketData.SCHEMA = _a$u.struct([
      ['key', 'u8'],
  ...
  _a$t = WhitelistedCreatorData;
  WhitelistedCreatorData.SCHEMA = _a$t.struct([
      ['key', 'u8'],
  ...
  var _a$r;
  class StoreConfigData extends Data {
      constructor(args) {
          super(args);
  ...
  _a$r = StoreConfigData;
  StoreConfigData.SCHEMA = _a$r.struct([
      ['key', 'u8'],
      ['settingsUri', { kind: 'option', type: 'string' }],
  ]);
  class StoreConfig extends Account {
      constructor(pubkey, info) {
          super(pubkey, info);
          if (!this.assertOwner(MetaplexProgram.PUBKEY)) {
              throw ERROR_INVALID_OWNER();
      ...
      static getPDA(store) {
          return __awaiter(this, void 0, void 0, function* () {
              return MetaplexProgram.findProgramAddress([
                  buffer.Buffer.from(MetaplexProgram.PREFIX),
                  MetaplexProgram.PUBKEY.toBuffer(),
                  buffer.Buffer.from(MetaplexProgram.CONFIG),
                  new web3_js.PublicKey(store).toBuffer(),
              ]);
          });
      }
  ...
  _a$q = SafetyDepositBoxData;
  SafetyDepositBoxData.SCHEMA = _a$q.struct([
      ['key', 'u8'],
      ['vault', 'pubkeyAsString'],
      ['tokenMint', 'pubkeyAsString'],
      ['store', 'pubkeyAsString'],
  ...
  _a$o = ExternalPriceAccountData;
  ExternalPriceAccountData.SCHEMA = _a$o.struct([
      ['key', 'u8'],
      ['pricePerShare', 'u64'],
  ...
  _a$n = CombineVaultArgs;
  CombineVaultArgs.SCHEMA = _a$n.struct([['instruction', 'u8']]);
  ...
  _a$m = InitVaultArgs;
  InitVaultArgs.SCHEMA = _a$m.struct([
      ['instruction', 'u8'],
      ['allowFurtherShareCreation', 'u8'],
  ]);
  ...
  _a$l = RedeemSharesArgs;
  RedeemSharesArgs.SCHEMA = _a$l.struct([['instruction', 'u8']]);
  ...
  _a$k = SetVaultAuthorityArgs;
  SetVaultAuthorityArgs.SCHEMA = _a$k.struct([['instruction', 'u8']]);
  ...
  _a$j = UpdateExternalPriceAccountArgs;
  ...
  _a$i = EditionData;
  EditionData.SCHEMA = _a$i.struct([
      ['key', 'u8'],
  ...
  _a$h = EditionMarkerData;
  EditionMarkerData.SCHEMA = _a$h.struct([
      ['key', 'u8'],
      ['ledger', [31]],
  ]);
  ...
  _a$g = MasterEditionV1Data;
  MasterEditionV1Data.SCHEMA = _a$g.struct([
      ['key', 'u8'],
      ['supply', 'u64'],
  ...
  _a$c = CreateMasterEditionArgs;
  CreateMasterEditionArgs.SCHEMA = _a$c.struct([
      ['instruction', 'u8'],
      ['maxSupply', { kind: 'option', type: 'u64' }],
  ]);
  ...
  _a$b = MintNewEditionFromMasterEditionViaTokenArgs;
  MintNewEditionFromMasterEditionViaTokenArgs.SCHEMA = _a$b.struct([
      ['instruction', 'u8'],
      ['edition', 'u64'],
  ]);
  ...
  _a$a = UpdatePrimarySaleHappenedViaTokenArgs;
  UpdatePrimarySaleHappenedViaTokenArgs.SCHEMA = _a$a.struct([['instruction', 'u8']]);
  ...
  _a$9 = SignMetadataArgs;
  SignMetadataArgs.SCHEMA = _a$9.struct([['instruction', 'u8']]);
  ...
  _a$8 = SetStoreArgs;
  SetStoreArgs.SCHEMA = _a$8.struct([
      ['instruction', 'u8'],
      ['public', 'u8'],
  ]);
  ...
  var _a$7;
  class SetStoreV2Args extends Data {
      constructor() {
          super(...arguments);
          this.instruction = 23;
      }
  ...
  _a$7 = SetStoreV2Args;
  SetStoreV2Args.SCHEMA = _a$7.struct([
      ['instruction', 'u8'],
      ['public', 'u8'],
      ['settingsUri', { kind: 'option', type: 'string' }],
  ]);
  class SetStoreV2 extends Transaction {
      constructor(options, params) {
          super(options);
          const { feePayer } = options;
  ...
  _a$6 = SetWhitelistedCreatorArgs;
  SetWhitelistedCreatorArgs.SCHEMA = _a$6.struct([
      ['instruction', 'u8'],
      ['activated', 'u8'],
  ]);
  ...
  _a$5 = StartAuctionArgs;
  StartAuctionArgs.SCHEMA = _a$5.struct([['instruction', 'u8']]);
  ...
  _a$4 = InitAuctionManagerV2Args;
  InitAuctionManagerV2Args.SCHEMA = _a$4.struct([
      ['instruction', 'u8'],
      ['amountType', 'u8'],
      ['lengthType', 'u8'],
      ['maxRanges', 'u64'],
  ...
  _a$3 = ClaimBidArgs;
  ClaimBidArgs.SCHEMA = _a$3.struct([['instruction', 'u8']]);
  ...
  _a$2 = RedeemBidArgs;
  RedeemBidArgs.SCHEMA = _a$2.struct([['instruction', 'u8']]);
  ...
  _a$1 = RedeemFullRightsTransferBidArgs;
  RedeemFullRightsTransferBidArgs.SCHEMA = _a$1.struct([['instruction', 'u8']]);
  ...
  var _a;
  class RedeemPrintingV2BidArgs extends Data {
      constructor() {
          super(...arguments);
          this.instruction = 14;
      }
  ...
  class RedeemPrintingV2Bid extends Transaction {
      constructor(options, params) {
          super(options);
          const { feePayer } = options;
  ...
  const redeemPrintingV2Bid = ({ connection, wallet, store, auction, }) => __awaiter(void 0, void 0, void 0, function* () {
      ...
      const { mint, createMintTx, createAssociatedTokenAccountTx, mintToTx, recipient } = yield prepareTokenAccountAndMintTx(connection, wallet.publicKey);
  ...
  const instantSale = ({ connection, wallet, store, auction, }) => __awaiter(void 0, void 0, void 0, function* () {
      ...
      const [safetyDepositBox] = yield vault.getSafetyDepositBoxes(connection);
      const safetyDepositConfigPDA = yield SafetyDepositConfig.getPDA(auctionManagerPDA, safetyDepositBox.pubkey);
      const { data: { winningConfigType }, } = yield SafetyDepositConfig.load(connection, safetyDepositConfigPDA);
      const { txId: placeBidTxId, bidderPotToken, bidderMeta, } = yield placeBid({
          connection,
          wallet,

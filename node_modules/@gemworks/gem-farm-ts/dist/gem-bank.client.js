...
const account_utils_1 = require("./gem-common/account-utils");
const types_1 = require("./gem-common/types");
var BankFlags;
(function (BankFlags) {
...
class GemBankClient extends account_utils_1.AccountUtils {
    ...
    findVaultAuthorityPDA(vault) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.findProgramAddress(this.bankProgram.programId, [vault]);
        });
    }
    findWhitelistProofPDA(bank, whitelistedAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.findProgramAddress(this.bankProgram.programId, [
                'whitelist',
                bank,
    ...
    initBank(bank, bankManager, payer) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const txSig = yield this.bankProgram.rpc.initBank({
                accounts: {
                    bank: bank.publicKey,
                    bankManager: (0, types_1.isKp)(bankManager)
                        ? bankManager.publicKey
                        : bankManager,
                    payer: (0, types_1.isKp)(payer) ? payer.publicKey : payer,
    ...
    initVault(bank, creator, payer, owner, name) {
        return __awaiter(this, void 0, void 0, function* () {
            const creatorPk = (0, types_1.isKp)(creator)
                ? creator.publicKey
                : creator;
            const [vault, vaultBump] = yield this.findVaultPDA(bank, creatorPk);
            const [vaultAuth, vaultAuthBump] = yield this.findVaultAuthorityPDA(vault); //nice-to-have
            const signers = [];
            if ((0, types_1.isKp)(creator))
                signers.push(creator);
            if ((0, types_1.isKp)(payer))
                signers.push(payer);
            console.log('creating vault at', vault.toBase58());
            const txSig = yield this.bankProgram.rpc.initVault(vaultBump, owner, name, {
                accounts: {
                    bank,
                    vault,
                    creator: creatorPk,
    ...
    updateVaultOwner(bank, vault, existingOwner, newOwner) {
        return __awaiter(this, void 0, void 0, function* () {
            const signers = [];
            if ((0, types_1.isKp)(existingOwner))
            ...
            const txSig = yield this.bankProgram.rpc.updateVaultOwner(newOwner, {
                accounts: {
                    bank,
                    vault,
                    owner: (0, types_1.isKp)(existingOwner)
    ...
    depositGem(bank, vault, vaultOwner, gemAmount, gemMint, gemSource, mintProof, metadata, creatorProof) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [gemRarity, gemRarityBump] = yield this.findRarityPDA(bank, gemMint);
            ...
            const signers = [];
            if ((0, types_1.isKp)(vaultOwner))
                signers.push(vaultOwner);
            console.log(`depositing ${gemAmount} gems into ${gemBox.toBase58()}, GDR ${GDR.toBase58()}`);
            const txSig = yield this.bankProgram.rpc.depositGem(vaultAuthBump, gemBoxBump, GDRBump, gemRarityBump, gemAmount, {
                accounts: {
                    bank,
                    vault,
                    owner: (0, types_1.isKp)(vaultOwner)
    ...
    addToWhitelist(bank, bankManager, addressToWhitelist, whitelistType, payer) {
        return __awaiter(this, void 0, void 0, function* () {
            const managerPk = (0, types_1.isKp)(bankManager)
                ? bankManager.publicKey
                : bankManager;
            const [whitelistProof, whitelistBump] = yield this.findWhitelistProofPDA(bank, addressToWhitelist);
            const signers = [];
            if ((0, types_1.isKp)(bankManager))
                signers.push(bankManager);
            const txSig = yield this.bankProgram.rpc.addToWhitelist(whitelistBump, whitelistType, {
                accounts: {
                    bank,
    ...
    removeFromWhitelist(bank, bankManager, addressToRemove) {
        return __awaiter(this, void 0, void 0, function* () {
            const [whitelistProof, whitelistBump] = yield this.findWhitelistProofPDA(bank, addressToRemove);
            const signers = [];
            if ((0, types_1.isKp)(bankManager))
                signers.push(bankManager);

...
export declare class GemBankClient extends AccountUtils {
    ...
    constructor(conn: Connection, wallet: Wallet, idl?: Idl, programId?: PublicKey);
    setProvider(): void;
    ...
    findVaultPDA(bank: PublicKey, creator: PublicKey): Promise<[anchor.web3.PublicKey, number]>;
    findGemBoxPDA(vault: PublicKey, mint: PublicKey): Promise<[anchor.web3.PublicKey, number]>;
    findGdrPDA(vault: PublicKey, mint: PublicKey): Promise<[anchor.web3.PublicKey, number]>;
    findVaultAuthorityPDA(vault: PublicKey): Promise<[anchor.web3.PublicKey, number]>;
    findWhitelistProofPDA(bank: PublicKey, whitelistedAddress: PublicKey): Promise<[anchor.web3.PublicKey, number]>;
    findRarityPDA(bank: PublicKey, mint: PublicKey): Promise<[anchor.web3.PublicKey, number]>;
    ...
    removeFromWhitelist(bank: PublicKey, bankManager: PublicKey | Keypair, addressToRemove: PublicKey): Promise<{
        whitelistProof: anchor.web3.PublicKey;
        whitelistBump: number;
        txSig: string;
    }>;

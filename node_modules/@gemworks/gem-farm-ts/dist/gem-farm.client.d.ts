...
export declare class GemFarmClient extends GemBankClient {
    ...
    constructor(conn: Connection, wallet: Wallet, farmIdl?: Idl, farmProgramId?: PublicKey, bankIdl?: Idl, bankProgramId?: PublicKey);
    ...
    findFarmerPDA(farm: PublicKey, identity: PublicKey): Promise<[anchor.web3.PublicKey, number]>;
    findFarmAuthorityPDA(farm: PublicKey): Promise<[anchor.web3.PublicKey, number]>;
    findFarmTreasuryPDA(farm: PublicKey): Promise<[anchor.web3.PublicKey, number]>;
    findAuthorizationProofPDA(farm: PublicKey, funder: PublicKey): Promise<[anchor.web3.PublicKey, number]>;
    findRewardsPotPDA(farm: PublicKey, rewardMint: PublicKey): Promise<[anchor.web3.PublicKey, number]>;
    ...
    updateFarm(farm: PublicKey, farmManager: PublicKey | Keypair, config?: FarmConfig | null, newManager?: PublicKey | null): Promise<{
        txSig: string;
    }>;
    ...
    stakeCommon(farm: PublicKey, farmerIdentity: PublicKey | Keypair, unstake?: boolean): Promise<{
        farmer: anchor.web3.PublicKey;
        farmerBump: number;
        vault: anchor.web3.PublicKey;
        vaultBump: number;
    ...
    unstake(farm: PublicKey, farmerIdentity: PublicKey | Keypair): Promise<{
        farmer: anchor.web3.PublicKey;
        farmerBump: number;
        vault: anchor.web3.PublicKey;
        vaultBump: number;
